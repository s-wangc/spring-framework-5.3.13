...
public abstract class AbstractListenerWebSocketSession<T> extends AbstractWebSocketSession<T>
	 ...
	 * <p><strong>注意:</strong> Sub-classes are encouraged to start out in
	 ...
	 * <p><strong>注意:</strong> if the underlying WebSocket API does not provide
	 ...
	 * <p><strong>注意:</strong> Sub-classes are responsible for releasing the
