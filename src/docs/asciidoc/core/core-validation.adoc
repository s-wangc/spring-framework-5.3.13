...
注意: Because `GenericConverter` is a more complex SPI interface, you should use
...
注意: If no `ConversionService` is registered with Spring, the original `PropertyEditor`-based
system is used.
