...
ifdef::backend-html5[]
注意: This documentation is also available as {docs-spring-framework}/reference/pdf/index.pdf[PDF].
endif::[]

ifdef::backend-pdf[]
注意: This documentation is also available as {docs-spring-framework}/reference/html/index.html[HTML].
endif::[]
